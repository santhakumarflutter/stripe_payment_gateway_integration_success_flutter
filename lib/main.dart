...
class _PaymentState extends State<Payment> {
  ...
  final String _currentSecret =
      "sk_test_51LYrvSSCN15oHJOcrFnGpV9VWPyMYwy6qjQqOIryZlaGCnDAQhUF0jN6glmapSsJMRzhtuatlxtUUsEpHdQah6Vi00nxhk26S6"; //set this yourself, e.g using curl
  ...
  initState() {
    ...
    StripePayment.setOptions(StripeOptions(
        //this key is taken from stripe santhakumarflutter@gmail.com account
        publishableKey:
            "pk_test_51LYrvSSCN15oHJOcQvLlzKkibd8eTWyh6hVE6wxfFCyUN6bW39KmAnGvZxP5aDVVIXC1FSnQ9wN4SIExwevjqLd500asxLtPoK",
        merchantId: "acct_1LYrvSSCN15oHJOc",
        androidPayMode: 'test'));
  }
